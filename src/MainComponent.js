         ...
         {this.props.todoReducer.todo.map((todo, index) => (
          ...
          <div className='AddField'>
            ...
            <div>
              ...
              <button onClick={() => this.props.deleteOneTask()}>Remove One Task</button>
